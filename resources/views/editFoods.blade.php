...
@section('content')
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card    ">
                    <div class="card-header">{{ __('Updating Foods') }}</div>
                    <form method="POST" action="/foods/{{$data->id}}" enctype="multipart/form-data">
                        @method('PATCH')
                        <div class="card-body">
                            @csrf
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="name" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$data->name}}"  autocomplete="name" autofocus>
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-md-6">
                                    <input id="price" type="number" class="form-control @error('price') is-invalid @enderror" name="price" value="{{$data->price}}"  autocomplete="price" autofocus>
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-md-6">
                                    <select id="type" name="type" class="form-control form-select  @error('type') is-invalid @enderror" aria-label="Default select example" value="{{$data->type}}"  autocomplete="type" autofocus>
                                        <option value="food" @if ($data['type']=="food")selected @endif >Food</option>
                                        <option value="drink" @if ($data['type']=="drink")selected @endif >Drink</option>
                                    </select>
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label" for="inlineCheckbox2">Pork</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="checkbox" name="sea" id="sea" value="1">
